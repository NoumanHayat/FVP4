...
const index = props => {
  ...
  const {initialCoaching} = useContext(DataContext);
  useEffect(() => { 
    ...
    <View style={Styles.container}>
      ...
      <View style={Styles.DetailBox}>
        <DataTable>
          ...
          <DataTable.Row>
            <DataTable.Cell>{ parseInt(detail.Calories)}</DataTable.Cell>
            <DataTable.Cell>{parseInt(detail.Fats)}</DataTable.Cell>
            <DataTable.Cell>{parseInt(detail.Carbs)}</DataTable.Cell>
            <DataTable.Cell>{parseInt(detail.Fats)}</DataTable.Cell>
          </DataTable.Row>
        </DataTable>
      </View>
