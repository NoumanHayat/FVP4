...
const weight = () => {
  const {progressTracking_getCarbs} = useContext(DataContext);
  ...
  useEffect(() => {
    async function fetchData() {
      const a = await progressTracking_getCarbs();
      console.log("===========================================");
      console.log(a);
      console.log("===========================================");
      setDetail(a);
                ...
                setListData([
                  {
                    ...
                    Carbs: detail.DailyData[0],
                  },
                  {
                    Date: detail.DailyLabel[1],
                    Carbs: detail.DailyData[1],
                  },
                  {
                    Date: detail.DailyLabel[2],
                    Carbs: detail.DailyData[2],
                  },
                  {
                    Date: detail.DailyLabel[3],
                    Carbs: detail.DailyData[3],
                  },
                  {
                    Date: detail.DailyLabel[4],
                    Carbs: detail.DailyData[4],
                  },
                  {
                    Date: detail.DailyLabel[5],
                    Carbs: detail.DailyData[5],
                  },
                ]);
                ...
                setListData([
                  {
                    ...
                    Carbs: detail.weeklyData[0],
                  },
                  {
                    Date: detail.weeklyLabel[1],
                    Carbs: detail.weeklyData[1],
                  },
                  {
                    Date: detail.weeklyLabel[2],
                    Carbs: detail.weeklyData[2],
                  },
                  {
                    Date: detail.weeklyLabel[3],
                    Carbs: detail.weeklyData[3],
                  },
                  {
                    Date: detail.weeklyLabel[4],
                    Carbs: detail.weeklyData[4],
                  },
                  {
                    Date: detail.weeklyLabel[5],
                    Carbs: detail.weeklyData[5],
                  },
                ]);
              } else {
                ...
                setListData([
                  {
                    ...
                    Carbs: detail.MonthlyData[0],
                  },
                  {
                    Date: detail.MonthlyLabel[1],
                    Carbs: detail.MonthlyData[1],
                  },
                  {
                    Date: detail.MonthlyLabel[2],
                    Carbs: detail.MonthlyData[2],
                  },
                  {
                    Date: detail.MonthlyLabel[3],
                    Carbs: detail.MonthlyData[3],
                  },
                  {
                    Date: detail.MonthlyLabel[4],
                    Carbs: detail.MonthlyData[4],
                  },
                  {
                    Date: detail.MonthlyLabel[5],
                    Carbs: detail.MonthlyData[5],
                  },
                ]);
              }
          ...
          renderItem={({item, index, separators}) => {
            return (
              <DataTable.Row>
                ...
                <DataTable.Cell>{parseInt(item.Carbs)}</DataTable.Cell>
              </DataTable.Row>
            );
          }}
        />
