...
const weight = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      const d = await progressTracking_getProtein();
      var a={
                ...
                setListData([
                  {
                    ...
                    Protein: detail.DailyData[0],
                  },
                  {
                    Date: detail.DailyLabel[1],
                    Protein: detail.DailyData[1],
                  },
                  {
                    Date: detail.DailyLabel[2],
                    Protein: detail.DailyData[2],
                  },
                  {
                    Date: detail.DailyLabel[3],
                    Protein: detail.DailyData[3],
                  },
                  {
                    Date: detail.DailyLabel[4],
                    Protein: detail.DailyData[4],
                  },
                  {
                ...
                setListData([
                  {
                    ...
                    Protein: detail.weeklyData[0],
                  },
                  {
                    Date: detail.weeklyLabel[1],
                    Protein: detail.weeklyData[1],
                  },
                  {
                    Date: detail.weeklyLabel[2],
                    Protein: detail.weeklyData[2],
                  },
                  {
                    Date: detail.weeklyLabel[3],
                    Protein: detail.weeklyData[3],
                  },
                  {
                    Date: detail.weeklyLabel[4],
                    Protein: detail.weeklyData[4],
                  },
                  {
                ...
                setListData([
                  {
                    ...
                    Protein: detail.MonthlyData[0],
                  },
                  {
                    Date: detail.MonthlyLabel[1],
                    Protein: detail.MonthlyData[1],
                  },
                  {
                    Date: detail.MonthlyLabel[2],
                    Protein: detail.MonthlyData[2],
                  },
                  {
                    Date: detail.MonthlyLabel[3],
                    Protein: detail.MonthlyData[3],
                  },
                  {
                    Date: detail.MonthlyLabel[4],
                    Protein: detail.MonthlyData[4],
                  },
                  {
          ...
          renderItem={({item, index, separators}) => {
            return (
              <DataTable.Row>
                ...
                <DataTable.Cell>{parseInt(item.Protein)}</DataTable.Cell>
              </DataTable.Row>
            );
          }}
        />
